...
pub enum IndexForAscTypeId {
    ...
    DogeArrayDataReceiver = 3000,
    DogeArrayCryptoHash = 3001,
    DogeArrayActionEnum = 3002,
    DogeArrayMerklePathItem = 3003,
    DogeArrayValidatorStake = 3004,
    DogeArraySlashedValidator = 3005,
    DogeArraySignature = 3006,
    DogeArrayChunkHeader = 3007,
    DogeAccessKeyPermissionEnum = 3008,
    DogeActionEnum = 3009,
    DogeDirectionEnum = 3010,
    DogePublicKey = 3011,
    DogeSignature = 3012,
    DogeFunctionCallPermission = 3013,
    DogeFullAccessPermission = 3014,
    DogeAccessKey = 3015,
    DogeDataReceiver = 3016,
    DogeCreateAccountAction = 3017,
    DogeDeployContractAction = 3018,
    DogeFunctionCallAction = 3019,
    DogeTransferAction = 3020,
    DogeStakeAction = 3021,
    DogeAddKeyAction = 3022,
    DogeDeleteKeyAction = 3023,
    DogeDeleteAccountAction = 3024,
    DogeActionReceipt = 3025,
    DogeSuccessStatusEnum = 3026,
    DogeMerklePathItem = 3027,
    DogeExecutionOutcome = 3028,
    DogeSlashedValidator = 3029,
    DogeBlockHeader = 3030,
    DogeValidatorStake = 3031,
    DogeChunkHeader = 3032,
    DogeBlock = 3033,
    DogeReceiptWithOutcome = 3034,
