...
impl AscIndexId for AscDataReceiverArray {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeArrayDataReceiver;
}
...
impl AscIndexId for AscCryptoHashArray {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeArrayCryptoHash;
}
...
impl AscIndexId for AscActionEnumArray {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeArrayActionEnum;
}
...
impl AscIndexId for AscMerklePathItemArray {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeArrayMerklePathItem;
}
...
impl AscIndexId for AscValidatorStakeArray {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeArrayValidatorStake;
}
...
impl AscIndexId for AscSlashedValidatorArray {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeArraySlashedValidator;
}
...
impl AscIndexId for AscSignatureArray {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeArraySignature;
}
...
impl AscIndexId for AscChunkHeaderArray {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeArrayChunkHeader;
}
...
impl AscIndexId for AscAccessKeyPermissionEnum {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeAccessKeyPermissionEnum;
}
...
impl AscIndexId for AscActionEnum {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeActionEnum;
}
...
impl AscIndexId for AscPublicKey {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogePublicKey;
}
...
impl AscIndexId for AscSignature {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeSignature;
}
...
impl AscIndexId for AscFunctionCallPermission {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeFunctionCallPermission;
}
...
impl AscIndexId for AscFullAccessPermission {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeFullAccessPermission;
}
...
impl AscIndexId for AscAccessKey {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeAccessKey;
}
...
impl AscIndexId for AscDataReceiver {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeDataReceiver;
}
...
impl AscIndexId for AscCreateAccountAction {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeCreateAccountAction;
}
...
impl AscIndexId for AscDeployContractAction {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeDeployContractAction;
}
...
impl AscIndexId for AscFunctionCallAction {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeFunctionCallAction;
}
...
impl AscIndexId for AscTransferAction {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeTransferAction;
}
...
impl AscIndexId for AscStakeAction {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeStakeAction;
}
...
impl AscIndexId for AscAddKeyAction {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeAddKeyAction;
}
...
impl AscIndexId for AscDeleteKeyAction {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeDeleteKeyAction;
}
...
impl AscIndexId for AscDeleteAccountAction {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeDeleteAccountAction;
}
...
impl AscIndexId for AscActionReceipt {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeActionReceipt;
}
...
impl AscIndexId for AscSuccessStatusEnum {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeSuccessStatusEnum;
}
...
impl AscIndexId for AscMerklePathItem {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeMerklePathItem;
}
...
impl AscIndexId for AscExecutionOutcome {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeExecutionOutcome;
}
...
impl AscIndexId for AscSlashedValidator {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeSlashedValidator;
}
...
impl AscIndexId for AscBlockHeader {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeBlockHeader;
}
...
impl AscIndexId for AscValidatorStake {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeValidatorStake;
}
...
impl AscIndexId for AscChunkHeader {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeChunkHeader;
}
...
impl AscIndexId for AscBlock {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeBlock;
}
...
impl AscIndexId for AscReceiptWithOutcome {
    const INDEX_ASC_TYPE_ID: IndexForAscTypeId = IndexForAscTypeId::DogeReceiptWithOutcome;
}
