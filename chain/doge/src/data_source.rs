...
use crate::trigger::{DogeTrigger, ReceiptWithOutcome};

pub const DOGE_KIND: &str = "doge";
...
impl blockchain::DataSource<Chain> for DataSource {
    ...
    fn match_and_decode(
        ...
        let handler = match trigger {
            ...
            DogeTrigger::Block(_) => match self.handler_for_block() {
    ...
    fn from_stored_dynamic_data_source(
        ...
        // FIXME (DOGE): Implement me correctly
        todo!()
    }
...
impl TryFrom<DataSourceTemplateInfo<Chain>> for DataSource {
    ...
    fn try_from(_info: DataSourceTemplateInfo<Chain>) -> Result<Self, Error> {
        Err(anyhow!("Doge subgraphs do not support templates"))

        // How this might be implemented if/when Doge gets support for templates:
...
impl blockchain::DataSourceTemplate<Chain> for DataSourceTemplate {
    ...
    fn manifest_idx(&self) -> u32 {
        unreachable!("doge does not support dynamic data sources")
    }
}
